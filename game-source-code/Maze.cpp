    ...
    for( unsigned int i = 0; i<600; i++)
    {
        for(unsigned int j = 0; j<600; j++)
        {
            if(i==115 && j==95 || i==115 && j==185 ||i==157 && j==95||i==157 && j==230||i==451 && j==95 ||i==493 && j==185||
                    i==493 && j==95 || i==451 && j==230||i==115 && j==484 || i==157 && j==484||i==451 && j==484 || i==493 && j==484||
            ...
            else if(i == 199 && j ==95 || i == 325 && j == 95|| i == 199 && j ==519 || i == 325 && j == 519|| i==242 && j==272 || i==286 && j==272 )
            {
    ...
    for( unsigned int i = 0; i<600; i++)
    {
        for(unsigned int j = 0; j<600; j++)
        {
            ...
            if(i==73 && j==278 || i==115 && j==278|| i==157 && j==278 ||i==199 && j==278
                    ...
                    || i==199 && j==96 || i==413 && j==96 || i==199 && j==519 || i==412 && j==519
            ...
            else if(i==115 && j==95 || i==115 && j==132 || i==115 && j==185 || i==115 && j==225
                    || i==115 && j==355 || i==115 && j==438 || i==115 && j==485 || i==115 && j==522
                    || i==451 && j==95  || i==451 && j==132 || i==452 && j==185 || i==451 && j==225
                    || i==451 && j==355 || i==451 && j==438 || i==451 && j==485 || i==451 && j==522
                    || i==283 && j==95  || i==283 && j==185 || i==283 && j==477 || i==283 && j==519
